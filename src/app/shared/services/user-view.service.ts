...
export class UserViewService {
  private currentViewSubject = new BehaviorSubject<"tenant" | "landlord">("tenant")
  public currentView$: Observable<"tenant" | "landlord"> = this.currentViewSubject.asObservable()

  constructor(private router: Router) {
    // Initialize view based on current URL or localStorage
    const savedView = localStorage.getItem("userView") as "tenant" | "landlord" | null
